...
extern void *__capability cheri_codeptrperm(void (*codeptr)(void), ptraddr_t len, long perm);

extern void *__capability cheri_ptrperm(void *ptr, size_t len, long perm);
...
int sandbox_1_func(int *__capability intcap)
{
    ...
    (void) libcheri_invoke(sb1_obj, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL,
                           NULL, NULL);
...
void sandbox_2_func()
{
    ...
    (void) libcheri_invoke(sb2_obj, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL,
                           NULL, NULL);
...
int main() // remove unused args
{
    ...
    sandbox_1_codecap =
        cheri_seal(codecap_create((void (*)(void)) & sandbox_1_func, sandbox_code_1_ubound),
                   sandbox_1_sealcap);
    ...
    sandbox_1_datacap =
        cheri_seal(datacap_create((void *) sandbox_data_1_lbound, (void *) sandbox_data_1_ubound),
                   sandbox_1_sealcap);
    ...
    sandbox_2_codecap = cheri_seal(
        codecap_create((void (*)(void))(&sandbox_2_func), sandbox_2_code_end), sandbox_2_sealcap);

    //- sandbox_2 data cap -//
    void *sandbox2_lbound = (void *) ((size_t) apprx_data_UB - 1000); // approx
    sandbox_2_datacap =
        cheri_seal(datacap_create(sandbox2_lbound, apprx_data_UB), sandbox_2_sealcap);
    ...
    *heap_cap = 10;
    ...
    main_obj.co_datacap = cheri_perms_and(main_obj.co_datacap, CHERI_PERM_STORE | CHERI_PERM_LOAD |
    CHERI_PERM_LOAD_CAP | CHERI_PERM_SEAL); main_obj.co_datacap = cheri_seal(main_obj.co_datacap,
    sealcap);
